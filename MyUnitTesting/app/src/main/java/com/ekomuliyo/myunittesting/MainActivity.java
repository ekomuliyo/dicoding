...
public class MainActivity extends AppCompatActivity implements View.OnClickListener{
    ...
    private Button btnCalculateVolume, btnCalculateSurfaceArea, btnCalculateCircumreference, btnSave;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnCalculateCircumreference = findViewById(R.id.btn_calculate_circumference);
        ...
        btnCalculateCircumreference.setOnClickListener(this);
    ...
    public void onClick(View v) {
        ...
        if (TextUtils.isEmpty(length)){
            ...
            if (v.getId() == R.id.btn_save){
                ...
                tvResult.setText(String.valueOf(mainViewModel.getCircumreference()));
                gone();
            }
    ...
    private void gone() {
        ...
        btnCalculateCircumreference.setVisibility(View.GONE);
    ...
    private void visible() {
        ...
        btnCalculateCircumreference.setVisibility(View.VISIBLE);
