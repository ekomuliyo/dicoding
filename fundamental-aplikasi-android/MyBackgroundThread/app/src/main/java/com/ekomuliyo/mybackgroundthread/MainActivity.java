package com.ekomuliyo.mybackgroundthread;
...
public class MainActivity extends AppCompatActivity implements MyAsyncCallback{
    ...
    private final static String INPUT_STRING = "Halo ini Demo AsyncTask cooy!";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        DemoAsync demoAsync = new DemoAsync(this); // paremeter construktor DemoAsync adalah context bisa di tulis dengan this
    ...
    private static class DemoAsync extends AsyncTask<String, Void, String> {
        ...
        protected String doInBackground(String... strings) {
            ...
            try {
                ...
                output = input + " Selemat Belajar es!";
                Thread.sleep(2000);
            }catch (Exception e){
