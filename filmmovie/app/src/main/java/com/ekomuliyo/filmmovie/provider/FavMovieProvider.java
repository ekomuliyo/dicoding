package com.ekomuliyo.filmmovie.provider;
...
public class FavMovieProvider extends ContentProvider {
    ...
    private static final String AUTHORITY = "com.ekomuliyo.filmmovie.provider";
    ...
    public boolean onCreate() {
        movieDatabase = Room.databaseBuilder(getContext(), MovieDatabase.class, DB_NAME).build();
